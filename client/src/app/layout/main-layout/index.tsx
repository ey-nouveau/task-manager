...
export const MainLayout = () => {
  ...
  const getTopSectionClass = () => {
    if (location.pathname === "/")
      return `${styles.topSection} ${styles.topSectionHome}`;
    if (location.pathname === "/dashboard")
      return `${styles.topSection} ${styles.topSectionDashboard}`;
  ...
  return (
    <div className={styles.appContainer}>
      <Col className={styles.appWindow}>
        ...
        <div
          className={`${styles.bottomSection} ${location.pathname === "/" ? styles.bottomSectionHome : ""}`}
        >
          <Outlet />
        </div>
      </Col>
